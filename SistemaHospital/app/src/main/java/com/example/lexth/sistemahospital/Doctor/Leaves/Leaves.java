package com.example.lexth.sistemahospital.Doctor.Leaves;
        ...
        switch (v.getId()) {
            ...
            default:
                ...
                if (ds1.equals("") || ds2.equals("") || ys1.equals("") || ys2.equals("")) {
                    Message.message(Leaves.this, "Por Favor llena todos los campos");
                } else {
                    ...
                    if (b) {
                        Message.message(Leaves.this, "Solicitud Enviada");
                    } else {
                        Message.message(Leaves.this, "Esta Solicitud ya se Envio");
                    }
                    dbh.close();
                }
        }
