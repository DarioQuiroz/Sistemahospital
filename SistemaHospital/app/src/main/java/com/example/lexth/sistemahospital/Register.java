        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fnames.equals("") || lnames.equals("") || ages.equals("") || dds.equals("") ||
                    ...
                    Message.message(Register.this, "Por Favor llene todos los campos");
                } else {
                    ...
                    if (y.moveToFirst()) {
                        Message.message(Register.this, "El usuario ya existe");
                        Message.message(Register.this, "Inicie Sesion con su Usuario y Contraseña");
                        finish();
                    } else {
