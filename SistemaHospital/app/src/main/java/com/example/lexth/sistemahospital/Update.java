...
import com.example.lexth.sistemahospital.Desktop_Admin.Desktop_Admin;
import com.example.lexth.sistemahospital.Doctor.Doctor;
import com.example.lexth.sistemahospital.Patient.Patient;
import com.example.lexth.sistemahospital.Staff_Member.Staff_Member;
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fnames.equals("") || lnames.equals("") || ages.equals("") || dds.equals("") ||
                    ...
                    Message.message(Update.this, "Por Favor llene todos los campos");
                } else {
                    ...
                    if (b) {
                        Message.message(Update.this, "La Informacion del Usuario se ha Actualizado");
                        finish();
                    } else {
                        Message.message(Update.this, "Ha ocurrido un error en la Actualizacion");
                    }
                }
            }
        });
