...
public class D_Slot extends AppCompatActivity {
    ...
    public void onClick(View view) {
        ...
        if (y.moveToFirst()) {
            ...
            if (b) {
                Message.message(D_Slot.this, "Su agenda se ha actualizado");
            } else {
                Message.message(D_Slot.this, "Ha ocurrido un error, Intentalo de Nuevo");
            }
        } else {
            boolean b = db.insert_slot(username, password, "", s, e, "Y");
            if (b) {
                Message.message(D_Slot.this, "Su espacio ha sido insertado");
            } else {
                Message.message(D_Slot.this, "Ha ocurrido un error, Intentalo de Nuevo");
            }
        }
