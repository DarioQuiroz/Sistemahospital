    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.b_apply:
                ...
                if (problem.length() == 0) {
                    Message.message(Apply.this, "Por Favor Escriba su Problema");
                } else {
                    ...
                    if (b) {
                        Message.message(Apply.this, "Su Solicitud ha sido Enviada");
                        finish();
                    } else {
                        Message.message(Apply.this, "Error...Intenta Otra Vez");
                    }
                }
                break;
        }
