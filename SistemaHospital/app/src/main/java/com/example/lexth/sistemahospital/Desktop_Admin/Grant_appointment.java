...
import com.example.lexth.sistemahospital.CustomListViewAdapter;
...
import com.example.lexth.sistemahospital.RowItem;
...
public class Grant_appointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (y.moveToFirst()) {
            ...
            Message.message(Grant_appointment.this, "No hay Citas Pendientes");
            finish();
        }
        ...
        lv_appointment.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (y) {
                    Message.message(Grant_appointment.this, "Solicitud Aprobada");
                    finish();
                } else {
                    Message.message(Grant_appointment.this, "No Aprobada");
                }
            }
        });
    }
