    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_assign.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (z.moveToFirst()) {
                    Message.message(Assign_Staff.this, "Par ya asignado");
                } else {
                    boolean x = dbh.insert_staff(s_u.get(id_s), s_p.get(id_s), d_u.get(id_d), d_p.get(id_d), "Y");

                    if (x) {
                        Message.message(Assign_Staff.this, "Personal asignado");
                    } else {
                        Message.message(Assign_Staff.this, "Ha ocurrido un error");
                    }
                }
            }
        });
